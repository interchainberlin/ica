...
# chan-open-try
hermes -c $CONFIG_DIR tx raw chan-open-try test-2 test-1 connection-0 transfer transfer -s channel-0
# chan-open-ack
hermes -c $CONFIG_DIR tx raw chan-open-ack test-1 test-2 connection-0 transfer transfer -d channel-0 -s channel-0
# chan-open-confirm
